---
name: search-first
description: Research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Delegates research to a subagent when needed.
---
...
| Skills directory | `ls ~/.claude/skills .claude/skills` where applicable | Say no local skill catalog was available |
...
### With planning
Run the research step before architecture planning:
- Research identifies available tools
- The implementation plan incorporates them
- Avoids "reinventing the wheel" in the plan

### With architecture decisions
Consult research output for:
