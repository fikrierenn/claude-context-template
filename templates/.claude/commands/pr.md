...
Check for related artifacts produced by `/plan`:
- `plans/` — Plans executed by this PR (`plans/NN-<slug>.md` veya `plans/*.plan.md`)
- `docs/ADR/` — Architecture decisions this PR implements
