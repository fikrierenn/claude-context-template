...
| Dosya | Ne |
|---|---|
| `.claude/turkce-kapi.json` | `{"kapsam":["src","tests"],"alan_adlari":["UrunAdi"],"tabanli_kokler":["legacy"],"dosya_adi_istisnalari":[],"uzantilar":[".cs",".razor",".js",".py",".ps1",".sql"],"bicim":true,"bilesen":{"onekler":["btn","form","view"]},"sozlesme_adlari":["stokAdi","mailDurum"]}` — `uzantilar` yoksa süpürme yalnız .cs/.razor (1.7.0); `bicim`/`bilesen` yoksa o katmanlar kapalı (1.8.0, opt-in) |
